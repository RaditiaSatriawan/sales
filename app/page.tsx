...
import { getInvoiceToken } from "./services/api";
...
export default function Home() {
	...
	const WHATSAPP_URL =
		"https://wa.me/6285128012705?text=Halo%20Polisimuda%2C%20saya%20tertarik%20untuk%20berlangganan";
				...
				<div className="container">
					<div className="hero-wrapper">
						...
						<div className="hero-content">
							...
							<h1 id="hero-title">
								Lulus Tes Polisi dengan <span>Tryout Realtime</span> dan
								Pembahasan Lengkap
							</h1>
							...
							<div className="hero-price">
								...
								<span className="hero-price-savings">
									Hemat Rp350.000 (70%)
								</span>
							</div>
							...
							<div className="hero-buttons">
								<button
									...
									aria-label="Mulai belajar tryout polisi sekarang"
								>
									<svg
						...
						<div
							className="hero-graduates"
							aria-label="Lulusan Polisimuda yang berhasil"
						>
							<div className="hero-graduate hero-graduate-1">
								...
								<div className="hero-graduate-label">
									<span className="hero-graduate-badge" aria-hidden="true">
										✓
									</span>
				...
				<div className="container">
					<div className="section-header reveal">
						...
						<p className="section-subtitle">
							Banyak calon polisi gagal bukan karena tidak mampu, tapi karena
							salah strategi persiapan.
						</p>
					</div>
					...
					<div className="problem-cards">
						<article className="problem-card reveal reveal-delay-1">
							...
							<div className="problem-content">
								...
								<p>
									Materi terlalu banyak, tidak tahu harus fokus ke bagian mana
									dulu untuk mendapatkan hasil maksimal.
								</p>
							</div>
						</article>
						...
						<article className="problem-card reveal reveal-delay-2">
							...
							<div className="problem-content">
								...
								<p>
									Belajar dari soal yang ternyata beda jauh dengan tes asli,
									jadi tidak terbiasa dengan pola soalnya.
								</p>
							</div>
						</article>
						...
						<article className="problem-card reveal reveal-delay-3">
							...
							<div className="problem-content">
								...
								<p>
									Saat tes, panik karena tidak terlatih mengerjakan soal dengan
						...
						<article className="problem-card reveal reveal-delay-4">
							...
							<div className="problem-content">
								...
								<p>
									Hanya tahu jawaban benar, tapi tidak paham konsep di baliknya.
				...
				<div className="container">
					<div className="section-header reveal">
						...
						<h2 id="solution-title" className="section-title">
							Kenapa Ribuan Orang Memilih Kami?
						</h2>
						<p className="section-subtitle">
							3 keunggulan utama yang membuat platform kami berbeda dan sudah
							terbukti membantu banyak peserta lulus.
						</p>
					</div>
					...
					<div className="solution-cards">
						<article className="solution-card reveal reveal-delay-1">
							...
							<p>
								Simulasi tes seperti aslinya! Timer berjalan, soal acak, dan
								langsung lihat skor setelah selesai. Latih mental dan
								kecepatanmu setiap hari.
							</p>
						...
						<article className="solution-card reveal reveal-delay-2">
							...
							<p>
								Dibuat berdasarkan pola tes terbaru. Tim kami rutin update soal
								agar selalu relevan dengan materi yang keluar di tes
								sesungguhnya.
							</p>
						...
						<article className="solution-card reveal reveal-delay-3">
							...
							<p>
								Tidak cukup hanya tahu jawaban benar. Pahami konsepnya lewat
								video penjelasan dan PDF yang bisa diunduh untuk belajar
								offline.
							</p>
					...
					<div className="testimonial-cards">
						<article className="testimonial-card reveal reveal-delay-1">
							<p className="testimonial-quote">
								"Awalnya ragu, tapi setelah coba tryoutnya, langsung ketagihan!
								Soalnya beneran mirip sama tes asli. Astungkara lulus di
								percobaan pertama."
							</p>
						...
						<article className="testimonial-card reveal reveal-delay-2">
							<p className="testimonial-quote">
								"Soal-soalnya sangat mirip dengan tes aslinya. Sistemnya juga
								sangat akurat."
							</p>
							<div className="testimonial-author">
								<div className="testimonial-avatar" aria-hidden="true">
						...
						<article className="testimonial-card reveal reveal-delay-3">
							<p className="testimonial-quote">
								"Fitur timer-nya bikin terlatih ngerjain cepat. Dulu sering
								kehabisan waktu, sekarang bisa selesai dengan santai."
							</p>
							<div className="testimonial-author">
								<div className="testimonial-avatar" aria-hidden="true">
									BW
			...
			<section className="cta" id="langganan" aria-labelledby="cta-title">
				<div className="container">
					<div className="cta-box reveal">
						...
						<p>
							Jangan biarkan persiapan yang salah menghancurkan impianmu. Mulai
							sekarang dengan platform yang sudah terbukti!
						</p>
						...
						<div className="cta-price">
							<div className="price-display">
								...
								<span className="price-discount cta-price-value">
									Rp150.000<span className="cta-price-period"> / 3 bulan</span>
								</span>
							</div>
						...
						<div className="cta-buttons">
							<button
								onClick={handleBelajarSekarang}
								className="btn btn-primary btn-lg"
								aria-label="Mulai belajar sekarang untuk persiapan tes polisi"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="20"
